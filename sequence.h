...
uint64_t slice(SNAKEVAL seq_val, SNAKEVAL start_idx_val, SNAKEVAL end_idx_val, SNAKEVAL step_val, uint64_t *alloc_ptr, uint64_t *cur_frame, uint64_t *cur_stack_top) asm("?slice");
